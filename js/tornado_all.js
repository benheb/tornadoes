  ...
  function getTornadoes() {
    d3.csv("data/tornadodata-6617.csv")
      .row(function(d) { return {startLat: d.TouchdownLat, startLon: d.TouchdownLon, 
         endLat: d.LiftoffLat, endLon: d.LiftoffLon, date: new Date(d.Date).getTime(), scale: d.Fujita, injuries: d.Injuries, damage: d.Damage, state: d.State1, county: d.County1}; })
      .get(function(error, rows) { 
        ...
        var start = rows[ 0 ].date;
        var end = rows[ rows.length - 1 ].date; 
